...
Create apps with rich user interfaces for modern web business applications, responsive across browsers and devices, based on HTML5. \(Documentation patch 1.104.0\)

> ### Caution:  
>  The documentation development of OpenUI5 1.104 is still in progress for this patch, so there may be information missing. 
