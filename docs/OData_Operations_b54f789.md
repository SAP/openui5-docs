...
view on: [demo kit nightly build](https://sdk.openui5.org/nightly/#/topic/b54f7895b7594c61a83fa7257fa9d13f) | [demo kit latest release](https://sdk.openui5.org/topic/b54f7895b7594c61a83fa7257fa9d13f)</div>
...
The promise returned by the operation binding's [`invoke`](https://sdk.openui5.org/api/sap.ui.model.odata.v4.ODataContextBinding/methods/invoke) method may resolve with a *return value context* provided the conditions specified in [`invoke`](https://sdk.openui5.org/api/sap.ui.model.odata.v4.ODataContextBinding/methods/invoke) are met. The operation binding may be bound to an entity or a collection of entities.
