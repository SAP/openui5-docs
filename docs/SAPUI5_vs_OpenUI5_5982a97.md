...
If you're using the content delivery network, you can simply refer to `https://sdk.openui5.org/` \(for OpenUI5\) or `https://sdk.openui5.org/` \(for SAPUI5\), respectively. For more information, see [Variant for Bootstrapping from Content Delivery Network](Variant_for_Bootstrapping_from_Content_Delivery_Network_2d3eb2f.md).
