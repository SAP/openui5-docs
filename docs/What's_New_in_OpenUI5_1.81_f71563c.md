...
|**`sap.f.GridContainer`**We have enhanced the keyboard handling capabilities of the Grid Container. You can now navigate to the item below or above using the *Down Arrow* and *Up Arrow*. If you reach any of the borders of the Grid Container, the `borderReached` event will be fired.
