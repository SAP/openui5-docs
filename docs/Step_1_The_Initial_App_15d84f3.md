...
1.  To set up your project for this tutorial, download the files at [OData V4 - Step 1](https://sdk.openui5.org/entity/sap.ui.core.tutorial.odatav4/sample/sap.ui.core.tutorial.odatav4.01).
