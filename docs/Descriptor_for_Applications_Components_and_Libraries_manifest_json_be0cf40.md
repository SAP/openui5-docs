...
There is a new version of the app descriptor when the schema is changed. In the following table, you can see how the OpenUI5 version is related to the descriptor version and the value of `_version.`
