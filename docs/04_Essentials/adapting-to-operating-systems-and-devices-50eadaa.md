...
-   **[Controls with Built-In Device Adaptation](controls-with-built-in-device-adaptation-328a340.md "OpenUI5 comes with
...
-   **[Content Densities](content-densities-e54f729.md "The devices used to run apps that are developed with OpenUI5 run on various different
...
-   **[Options for Further Adaptation](options-for-further-adaptation-04eb520.md "In addition to those performed automatically by OpenUI5, the application can
