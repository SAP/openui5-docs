...
A new type of composite control, the XML composite control, is now available. It let's you build more flexible controls that contain separate XML and JavaScript parts. For more information, see [XML Composite Controls](XML_Composite_Controls__b83a4dc.md), the [API Reference](https://openui5.hana.ondemand.com/#/api/sap.ui.core.XMLComposite), and the [Samples](https://openui5.hana.ondemand.com/#/entity/sap.ui.core.XMLComposite). 
