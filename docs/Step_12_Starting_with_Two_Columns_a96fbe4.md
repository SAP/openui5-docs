...
**Previous:** [Step 13: Setting the Master-Detail Pattern](Step_13_Setting_the_Master-Detail_Pattern_cb38637.md "In this step, we set up the app to follow the master-detail pattern.")
