...
view on: [demo kit nightly build](https://sdk.openui5.org/nightly/#/topic/91f3b66b6f4d1014b6dd926db0e91070) | [demo kit latest release](https://sdk.openui5.org/topic/91f3b66b6f4d1014b6dd926db0e91070)</div>
...
For OpenUI5 applications, XSS vulnerabilities can exist on the following different levels:
