...
You can view and download all files at [Walkthrough - Step 16](https://sdk.openui5.org/explored.html#/sample/sap.m.tutorial.walkthrough.16/preview).
...
[API Reference: `sap.ui.core.Fragment`](https://sdk.openui5.orgdocs/api/symbols/sap.ui.core.Fragment.html)
