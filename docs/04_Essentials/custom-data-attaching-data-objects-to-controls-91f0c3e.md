...
-   **[Writing Data to the HTML DOM as DATA-\* Attribute](writing-data-to-the-html-dom-as-data-attribute-1ef9fef.md "OpenUI5 supports writing custom data to the HTML DOM.")**  
