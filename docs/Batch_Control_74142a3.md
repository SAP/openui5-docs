...
The same holds true for [Creating an Entity in a Collection](Creating_an_Entity_in_a_Collection_c9723f8.md) and [Deleting an Entity](Deleting_an_Entity_2613ebc.md).
