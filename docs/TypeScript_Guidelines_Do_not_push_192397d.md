...
TypeScript is a superset of JavaScipt that extends its capabilities by adding optional static types. We encourage you to use OpenUI5 with TypeScript for an improved development efficiency and experience. TypeScript would enable you to catch errors during the development process, allows better tooling and code refactoring, and improves code readability and maintainability.
