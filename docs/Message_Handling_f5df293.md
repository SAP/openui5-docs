...
view on: [demo kit nightly build](https://sdk.openui5.org/nightly/#/topic/f5df293b96dc41699b8b357e9bcf7ed6) | [demo kit latest release](https://sdk.openui5.org/topic/f5df293b96dc41699b8b357e9bcf7ed6)</div>
...
`MessagePopover` shows a summarized list of different types of messages \(errors, warnings, success and information\). It provides a handy and systemized way to navigate and explore details for every message. You can find more information on `MessagePopover` [here](Message_Popover_52824a6.md).
...
[Message Popover](Message_Popover_52824a6.md "Message Popover is used to show a summarized list of different types of messages (errors, warnings, success and information). It provides a handy and systemized way to navigate and explore details for every message.")
