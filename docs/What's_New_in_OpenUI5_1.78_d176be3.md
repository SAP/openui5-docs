...
| **`sap.m.MultiComboBox`, `sap.m.MultiInput`**
 ...
 |
|**`sap.ui.layout.Splitter`**-   A new `resetContentAreasSizes` method is now available that allows developers to programmatically reset the size of the content areas. For more information, see the [API Reference](https://openui5.hana.ondemand.com/#/api/sap.ui.layout.Splitter%23methods/resetContentAreasSizes).
