...
view on: [demo kit nightly build](https://sdk.openui5.org/nightly/#/topic/91f225ce6f4d1014b6dd926db0e91070) | [demo kit latest release](https://sdk.openui5.org/topic/91f225ce6f4d1014b6dd926db0e91070)</div>
...
> 
> -   Make use of [Supported Locales](Supported_Locales_and_Fallback_Chain_ec753bc.md) \(recommended\).
> 
