...
You can load the formatter via the [`require`](Require_Modules_in_XML_View_and_Fragment_b11d853.md) attribute in your XML and assign the module to the `MyFormatter` alias, which can then be used as follows:
