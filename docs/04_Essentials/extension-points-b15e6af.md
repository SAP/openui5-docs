...
[View Extension](../06_Extending_SAPUI5_Applications/view-extension-403c050.md "OpenUI5 uses extension points for extending standard views with custom content. The assignment of a custom view to an extension point is done in component customizing.")
