...
As of version 1.98, you can use coordinates for the X and Y axes by prodividng values for *xPercentage* and *yPercentage* properties. The values provided should be percentages, i.e. in the range [0 - 100], relative to the control, which will then be converted to exact coordinates in pixels:
